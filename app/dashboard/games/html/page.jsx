...
export default function VintageGameGeneratorPage() {
  ...
  const generateGame = async () => {
    ...
    if (!gameRequest.trim()) {
      setError('Please describe the aptos minigame properly you want to create');
      return;
    }
    ...
    try {
      const response = await axios.post('/api/html', { 
        prompt: `Create a aptos minigame black and white game: ${gameRequest}`
      }, {
        headers: {
